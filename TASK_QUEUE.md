...
| `TASK-SOURCE-PROVINCIAL-DISCOVERY-003` | proposed | Evaluate at most 2 more provincial sources using the pattern report criteria; no bulk monitoring and no generic framework unless evidence improves. |
