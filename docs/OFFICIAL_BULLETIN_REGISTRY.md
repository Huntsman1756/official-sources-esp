...
| BOP_ALMERIA | Boletin Oficial de la Provincia de Almeria | provincial | Almeria | Almeria | http://www.dipalme.org/Servicios/cmsdipro/index.nsf/bop_view.xsp?p=dipalme | Almeria | pilot_validated | after_autonomous_p1 | Metadata-only ZK discovery monitor; no PDFs/artifacts/candidates/evidence. |
...
| BOP_GRANADA | Boletin Oficial de la Provincia de Granada | provincial | Granada | Granada | https://bop.dipgra.es/publica/consulta-de-bops/ | Granada | monitor_validated | metadata_only_html | Date-scoped HTML discovery monitor implemented; no PDFs/artifacts, candidates, or evidence-grade records. |
...
| BOP_SORIA | Boletin Oficial de la Provincia de Soria | provincial | Soria | Soria | https://bop.dipsoria.es/ | Soria | monitor_validated | metadata_only_html | Date-scoped HTML discovery monitor implemented; no PDFs/artifacts, candidates, or evidence-grade records. |
