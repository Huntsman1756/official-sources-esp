...
| BOP_ARABA_ALAVA | Boletin Oficial del Territorio Historico de Araba/Alava | provincial | Araba/Alava | Araba/Alava | http://www.araba.eus/botha/Inicio/SGBO5001.aspx | Araba/Alava | pilot_validated | after_autonomous_p1 | Metadata-only date-scoped HTML discovery; Spanish XML result links are recorded and PDFs are not downloaded. |
| BOP_AVILA | Boletin Oficial de la Provincia de Avila | provincial | Avila | Avila | https://www.diputacionavila.es/boletin-oficial/ | Avila | pilot_validated | after_autonomous_p1 | Metadata-only current-bulletin HTML discovery; PDF links are recorded but never downloaded. |
